...
public class FileUploadController {
    ...
    public ResponseEntity<ResponseObject> uploadFile(@RequestParam("file") MultipartFile file) {
        try {
            ...
            //86c2f088b59e450f98396d569147c0a1.png => how to open this file in Web Browser?
    ...
    //files/86c2f088b59e450f98396d569147c0a1.png
    ...
    public ResponseEntity<ResponseObject> getUploadedFiles() {
        try {
            List<String> urls = storageService.loadAll()
                    .map(path -> {
                        // Convert fileName to url(send "readDetailFile")
